...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?php echo base_url('View1/') ?>">View 1</a></li>
            <li class="menu-item hidden"><a href="<?php echo base_url('View2/') ?>">View 2</a>
            </li>
            <li class="menu-item hidden"><a href="<?php echo base_url('View3/') ?>">View 3</a></li>
        </ul>
    </div>

    <div class="heroe">

        <h1>Selamat Datang di Web UAS Pemrogaman 4</h1>
...
<section>
    ...
    <h1>Tentang Page Ini</h1>

    <p>Hiraukan saja, Hanya tampilan awal</p>
...
<footer>
    ...
    <div class="copyrights">
        ...
        <center><p>&copy; <?= date('Y') ?> HendrawanFedy</p></center>
